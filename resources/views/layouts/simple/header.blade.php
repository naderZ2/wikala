      ...
      <ul class="nav-menus">
          ...
          <div class="translate_wrapper">
            ...
            <div class="more_lang">
              ...
              <a href="{{ route('lang' , 'ae' )}}" class="{{ (App::getLocale()  == 'ae') ? 'active' : ''}}">
                <div class="lang {{ (App::getLocale()  == 'ae') ? 'selected' : ''}}" data-value="en"><i class="flag-icon flag-icon-eg"></i> <span class="lang-txt">لعربية</span> <span> (ae)</span></div>
              </a>
            </div>
          </div>
        </li>
        ...
        <li class="profile-nav onhover-dropdown p-0 me-0">
          ...
          <ul class="profile-dropdown onhover-show-div">
            ...
            <li><a href="{{ route('admin.logout') }}"><i data-feather="log-out"> </i><span>تسجيل الخروج</span></a></li>
          </ul>
        </li>
      </ul>
    </div>
