			...
			<div id="sidebar-menu">
				<ul class="sidebar-links" id="simple-bar">
					...
					<li class="sidebar-list">
						<label class="badge badge-success"></label><a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/dashboard' ? 'active' : '' }}" href="#"><i data-feather="home"></i><span class="lan-3">لوحة التحكم</span>
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu" style="display: {{request()->route()->getPrefix() == '/notifications' ? 'block' : 'none;' }};">
							<li><a href="{{route('admin.notifications.index')}}" class="{{ Route::currentRouteName()=='admin.notifications.index' ? 'active' : '' }}"> عرض الاشعارات</a></li>
						</ul>
					</li>

					<li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/financial' ? 'active' : '' }}" href="#">
