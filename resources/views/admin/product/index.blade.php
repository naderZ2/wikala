...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-12 mt-3">
			@can('add discount')
					<a href="{{route('product.create')}}"  class="btn btn-primary">@lang('lang.add_slider')</a>
				@endcan	
			<div class="card">
				<div class="card-body">
								...
								@forelse ($products as $product)
									<tr>
										...
										<td>
											...
											<a class="btn btn-primary" href="{{ route('product.edit',$product->id) }}" >@lang('lang.edit')</a>

											@if ($product->is_available == 1)
											<a href="{{ route('product.update',$product->id) }}" class="btn btn-danger mt-1" >
												@lang('lang.Disable')
											</a>

											@else
												<a href="{{ route('product.update',$product->id) }}" class="btn btn-success mt-1" >
													@lang('lang.Enable')
												</a>
											@endif

											<!--@if ($product?->deleted_at == null)-->
											<!--<a href="{{ route('product.hide_product',$product->id) }}" class="btn btn-success mt-1" >-->
											<!--	@lang('lang.Hide')-->
											<!--</a>-->
						
											<!--@else-->
											<!--<a href="{{ route('product.hide_product',$product->id) }}" class="btn btn-danger mt-1" >-->
											<!--	@lang('lang.Show')-->
											<!--</a>-->
