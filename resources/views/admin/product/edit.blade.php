	...
	<div class="row">
		<div class="col-sm-12">
			<div class="card">
				...
				<div class="card-body">
					<form class="needs-validation" novalidate="" method="POST" enctype="multipart/form-data" action="{{ route('product.updateProduct',$product->id) }}">
                        @csrf
                        @method('PUT')
						<div class="row">
							<div class="col-md-6 mb-3">
								...
								<input class="" id="" type="text" name="is_available" value="{{ $product->is_available }}" hidden>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="js-example-placeholder-multiple col-sm-12"  id="validationCustom03"  name="seller_id"  required="">
                                    ...
                                    <option {{ $seller->id == $product->seller_id ? 'selected' : '' }} value="{{$seller?->id}}">{{$seller?->name}}</option>                                  
						...
						<div class="row">
							...
							<div class="col-md-6 mb-3">
								...
								<input class="form-control" id="validationCustom04" type="number" placeholder="@lang('lang.quantity')" name="serving" value="{{ $product->serving }}"  >
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div id="inputFormRow">
                                            <div class="input-group mb-3">
                                                <input class="form-control" type="file" name="images[]" value="{{ old('images') }}" accept="image/*,video/*" >
                                                {{-- <div class="input-group-append">
                                                    <button id="removeRow" type="button" class="btn btn-danger">Remove</button>
                                                </div> --}}
                                            </div>
