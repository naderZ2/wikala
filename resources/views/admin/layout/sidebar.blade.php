		...
		<nav class="sidebar-main">
			...
			<div id="sidebar-menu">
				<ul class="sidebar-links" id="simple-bar">
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/dashboard' ? 'block;' : 'none;' }}">
							...
							<!--@endcan	-->
								...
								{{-- <li><a class="lan-4 {{ Route::currentRouteName()=='daily_events.index' ? 'active' : '' }}" href="{{route('daily_events.index')}}">{{ trans('lang.daily_events') }}</a></li>
							...
							<!--@can('add category')-->
							<!--<li><a class="lan-4 {{ Route::currentRouteName()=='event_category.create' ? 'active' : '' }}" href="{{route('event_category.create')}}">add event category</a></li>-->
							<!--@endcan	-->
							
						
							{{-- <li><a href="{{route('discounts.index')}}" class="{{ Route::currentRouteName()=='discounts.index' ? 'active' : '' }}">@lang('lang.discounts') </a></li> --}}
							<!--@can('add discount')-->
							<!--<li><a href="{{route('discounts.create')}}" class="{{ Route::currentRouteName()=='discounts.create' ? 'active' : '' }}">@lang('lang.add_discount') </a></li>-->
							<!--@endcan	-->
						</ul>
					</li>
					{{-- <li class="sidebar-list">
					...
					{{-- 
					<li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{ request()->route()->getPrefix() == '/users' ? 'active' : '' }}" href="#"><i data-feather="users"></i>
							<span class="lan-7">{{ trans('lang.Users') }}</span>
	                    ...
	                    <ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/users' ? 'block;' : 'none;' }}">
                          <li><a href="{{ route('admins.index') }}" class="{{ Route::currentRouteName() == 'admins.index' ? 'active' : '' }}">{{ trans('lang.admins') }}sss1</a></li>
						  <!--@can('add admin')-->
						  <!--<li><a href="{{ route('admins.create') }}" class="{{ Route::currentRouteName() == 'admins.create' ? 'active' : '' }}">{{ trans('lang.add_admin') }}</a></li>-->
						  <!--@endcan	-->
						  <li><a href="{{ route('admin.clients') }}" class="{{ Route::currentRouteName() == 'admin.clients' ? 'active' : '' }}">{{ trans('lang.Clients') }}ssss2</a></li>
                          <li><a href="{{ route('seller.index') }}" class="{{ Route::currentRouteName() == 'seller.index' ? 'active' : '' }}">@lang('lang.Sellers')sss3</a></li>
                          
                          
                          				<li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{ request()->route()->uri() == 'seller_services/index' ? 'active' : '' }}" href="#"><i data-feather="server"></i>
							<span class="lan-7">{{ trans('lang.seller_services') }}</span>
							<div class="according-menu"><i class="fa fa-angle-{{ request()->route()->uri() == 'seller_services/index' ? 'down' : 'right' }}"></i></div>
						</a>
	                    <ul class="sidebar-submenu" style="display: {{ request()->route()->uri() == 'seller_services/index' ? 'block;' : 'none;' }}">
                          <li><a href="{{ route('admin.sellerServices.index') }}" class="{{ Route::currentRouteName() == 'admin.sellerServices.index' ? 'active' : '' }}">{{ trans('lang.seller_services') }}</a></li>
						  <!--@can('add seller')-->
						  <!--<li><a href="{{ route('seller.create') }}" class="{{ Route::currentRouteName() == 'seller.create' ? 'active' : '' }}">@lang('lang.add_Seller') </a></li>-->
        <!--                  @endcan	-->
						  <!--<li><a href="{{ route('driver.index') }}" class="{{ Route::currentRouteName() == 'driver.index' ? 'active' : '' }}">@lang('lang.Drivers')</a></li>-->
        <!--                  @can('add driver')-->
						  <!--<li><a href="{{ route('driver.create') }}" class="{{ Route::currentRouteName() == 'driver.create' ? 'active' : '' }}">@lang('lang.add_Driver') </a></li>-->
						  <!--@endcan	-->
					...
					<li class="sidebar-list">
	                    ...
	                    <ul class="sidebar-submenu" style="display: {{ request()->route()->uri() == 'discounts' ? 'block;' : 'none;' }}">
							<li><a href="{{route('discounts.index')}}" class="{{ Route::currentRouteName()=='discounts.index' ? 'active' : '' }}">@lang('lang.discounts') </a></li>
					...
					<li class="sidebar-list">
	                    ...
	                    <ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/events' ? 'block;' : 'none;' }}">
							...
							<li><a class="lan-4 {{ request()->get('eventiFlter') == 'expired' ? 'active' : '' }}" href="{{route('daily_events.index', ['eventiFlter' => 'expired'] )}}">{{ trans('lang.expired') }}</a></li>
							<li><a class="lan-4 {{ request()->get('eventiFlter') == 'rejected' ? 'active' : '' }}" href="{{route('daily_events.index', ['eventiFlter' => 'rejected'] )}}">{{ trans('lang.rejected_events') }}</a></li>
					...
					<li class="sidebar-list">
					  ...
					  {{-- <li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/chat' ? 'active' : '' }}" href="#">
							<i data-feather="message-circle"></i><span>الاستشارات</span>
					...
					<li class="sidebar-list">
						{{-- <a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/evaluations' ? 'active' : '' }}" href="#">
							<i data-feather="star"></i><span>التقييمات</span>
					...
					<li class="sidebar-list">
						{{-- <a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/orders' ? 'active' : '' }}" href="#">
							<i data-feather="dollar-sign"></i><span> @lang('lang.products_orders')</span>
						...
						{{-- <ul class="sidebar-submenu" style="display: {{request()->route()->getPrefix() == '/financial' ? 'block' : 'none;' }};"> --}}
							...
							{{-- <li><a href="{{route('discounts.index')}}" class="{{ Route::currentRouteName()=='discounts.index' ? 'active' : '' }}">عرض الخصومات</a></li> --}}
						{{-- </ul> --}}
						<ul class="sidebar-submenu" style="display: {{request()->route()->getPrefix() == '/financial' ? 'block' : 'none;' }};">
							{{-- <li><a href="{{route('discounts.create')}}" class="{{ Route::currentRouteName()=='discounts.create' ? 'active' : '' }}">اضافة خصومات</a></li> --}}
						</ul>
					...
					<li class="sidebar-list">
						{{-- <a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/settings' ? 'active' : '' }}" href="#">
							<i data-feather="settings"></i><span>الاعدادت</span>
							<div class="according-menu"><i class="fa fa-angle-{{request()->route()->getPrefix() == '/settings' ? 'down' : 'right' }}"></i></div>
						</a> --}}
						<ul class="sidebar-submenu" style="display: {{request()->route()->getPrefix() == '/settings' ? 'block' : 'none;' }};">
							{{-- <li><a href="{{route('settings.edit')}}" class="{{ Route::currentRouteName()=='settings.edit' ? 'active' : '' }}">عرض الاعدادت</a></li> --}}
						</ul>
						
					</li>

					{{-- <li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/orders' ? 'active' : '' }}" href="#"><i data-feather="shopping-bag"></i><span>{{ trans('lang.products_orders') }}</span>
							<div class="according-menu"><i class="fa fa-angle-{{request()->route()->getPrefix() == '/orders' ? 'down' : 'right' }}"></i></div>
						</a>
					...
					<li class="sidebar-list">
					  ...
					  {{-- <li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{ request()->route()->uri() == 'special_request/index' ? 'active' : '' }}" href="#"><i data-feather="mail"></i>
							<span class="lan-7">{{ trans('lang.specialRequest') }}</span>
							<div class="according-menu"><i class="fa fa-angle-{{ request()->route()->uri() == 'special_request/index' ? 'down' : 'right' }}"></i></div>
						</a>
						
	                    <ul class="sidebar-submenu" style="display: {{ request()->route()->uri() == 'special_request/index' ? 'block;' : 'none;' }}">

							

								<li><a class="lan-4 {{ Route::currentRouteName()=='admin.specialRequest.index' ? 'active' : '' }}" href="{{route('admin.specialRequest.index')}}"> 
					...
					<li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{ request()->route()->uri() == 'orders/orders' ? 'active' : '' }}" href="#"><i data-feather="shopping-bag"></i>
							...
							<li><a href="{{ route('order.index') }}" class="{{ Route::currentRouteName() == 'order.index' ? 'active' : '' }}">@lang('lang.All_Orders')</a></li>

							<li><a href="{{ route('order.new') }}" class="{{ Route::currentRouteName() == 'order.new' ? 'active' : '' }}">@lang('lang.New_Orders')</a></li>

							<li><a href="{{ route('order.completed') }}" class="{{ Route::currentRouteName() == 'order.completed' ? 'active' : '' }}">@lang('lang.Completed_Orders')</a></li>
					...
					<li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/notifications' ? 'active' : '' }}" href="#">
							<i data-feather="bell"></i><span>@lang('lang.Notifications')</span>
							<div class="according-menu"><i class="fa fa-angle-{{request()->route()->getPrefix() == '/notifications' ? 'down' : 'right' }}"></i></div>
						</a>
						<ul class="sidebar-submenu" style="display: {{request()->route()->getPrefix() == '/notifications' ? 'block' : 'none;' }};">
							<li><a href="{{route('admin.notifications.index')}}" class="{{ Route::currentRouteName()=='admin.notifications.index' ? 'active' : '' }}">  @lang('lang.Notifications')</a></li>
							<!--@can('add notification')-->
							<!--<li><a href="{{route('admin.notifications.create')}}" class="{{ Route::currentRouteName()=='admin.notifications.create' ? 'active' : '' }}">  @lang('lang.add_Notification') </a></li>-->
							<!--@endcan	-->
						</ul>
					</li>
