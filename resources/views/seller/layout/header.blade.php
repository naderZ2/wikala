        ...
        <li class="profile-nav onhover-dropdown p-0 me-0">
          <div class="media profile-media">
            ...
            <div class="media-body">
              ...
              <p class="mb-0 font-roboto">{{ Auth::guard('seller')->user()->name }} <i class="middle fa fa-angle-down"></i></p>
            </div>
          </div>
          <ul class="profile-dropdown onhover-show-div">
            ...
            <li><a href="{{ route('seller.logout') }}"><i data-feather="log-out"> </i><span> @lang('lang.logout')</span></a></li>
          </ul>
        </li>
      </ul>
    </div>
