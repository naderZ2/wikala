...
<h3> @lang('lang.events_category') </h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item"> @lang('lang.Dashboard')</li>
<li class="breadcrumb-item active">@lang('lang.events_category')</li>
@endsection
										...
										<td>
											...
											<td class="actions">
												<form action="{{ route('event-categories.moveUp', $category->id) }}" method="POST">
													@csrf
													<button class="btn btn-success"  type="submit">@lang('lang.move-up')</button>
												</form>
												<form action="{{ route('event-categories.moveDown', $category->id) }}" method="POST">
													@csrf
	...
	<div class="modal-dialog" role="document">
	   <div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<form class="needs-validation" novalidate="" method="POST" enctype="multipart/form-data" action="{{ route('event_category.update') }}">
				@csrf
