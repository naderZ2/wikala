...
<h3>@lang('lang.add_Seller')</h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item">@lang('lang.Sellers')</li>
<li class="breadcrumb-item active">@lang('lang.add_Seller')</li>
@endsection
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="card">
				...
				<div class="card-body">
					<form class="needs-validation" novalidate="" method="POST" enctype="multipart/form-data" action="{{ route('seller.store') }}">
                        @csrf
						<div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div id="inputFormRow">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control" type="file" name="img_path" value="{{ old('img_path') }}" required accept="image/*" >
