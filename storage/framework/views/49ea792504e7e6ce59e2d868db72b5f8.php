				...
				<div class="card-body">
					<form class="needs-validation" novalidate="" method="POST" enctype="multipart/form-data" action="<?php echo e(route('settings.update')); ?>">
						...
						<div class="row">
							...
							<div class="col-md-6 mb-3">
								<label for="validationCustom01"><?php echo app('translator')->get('lang.delivery_fee'); ?></label>
								<input class="form-control" id="validationCustom01" type="text" name="delivery_fee" value="<?php echo e($settings->delivery_fee); ?>" required="">
								<div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">Please choose a access_token.</div>
							</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\OneDrive\Desktop\_\codeing\work\mazen\ezhalhaUpTo9\ezhalha\resources\views/admin/settings/edit.blade.php ENDPATH**/ ?>