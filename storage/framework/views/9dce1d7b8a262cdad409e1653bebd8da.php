...
<h3> <?php echo app('translator')->get('lang.events_category'); ?> </h3>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb-items'); ?>
<li class="breadcrumb-item"> <?php echo app('translator')->get('lang.Dashboard'); ?></li>
<li class="breadcrumb-item active"><?php echo app('translator')->get('lang.events_category'); ?></li>
<?php $__env->stopSection(); ?>
	...
	<div class="row">
	       <div class="d-flex justify-content-end col-sm-12">
				<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add category')): ?>
					<a href="<?php echo e(route('event_category.create')); ?>"  class="btn btn-primary"><?php echo app('translator')->get('lang.add_slider'); ?></a>
				<?php endif; ?>	
        	</div>
								...
								<?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
									<tr>
										...
										<td>
											...
											<?php endif; ?>	
											<form method="POST" action="<?php echo e(route('event_category.destroy',$category->id)); ?>" style="display: inline-block">
												<?php echo csrf_field(); ?>
												<button  class="btn btn-danger"  ><?php echo app('translator')->get('lang.Delete'); ?></button>
												
											</form>
											<td class="actions">
												<form action="<?php echo e(route('event-categories.moveUp', $category->id)); ?>" method="POST">
													<?php echo csrf_field(); ?>
													<button class="btn btn-success"  type="submit"><?php echo app('translator')->get('lang.move-up'); ?></button>
												</form>
												<form action="<?php echo e(route('event-categories.moveDown', $category->id)); ?>" method="POST">
													<?php echo csrf_field(); ?>
													<button class="btn btn-success" type="submit"><?php echo app('translator')->get('lang.move-down'); ?></button>
												</form>
											</td>
										</td>
	...
	<div class="modal-dialog" role="document">
	   <div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<form class="needs-validation" novalidate="" method="POST" enctype="multipart/form-data" action="<?php echo e(route('event_category.update')); ?>">
				<?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\OneDrive\Desktop\_\codeing\work\mazen\ezhalhaUpTo9\ezhalha\resources\views/admin/events/index_category.blade.php ENDPATH**/ ?>