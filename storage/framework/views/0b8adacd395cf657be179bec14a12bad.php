      ...
      <ul class="nav-menus">
          ...
          <div class="translate_wrapper">
            ...
            <div class="more_lang">
              ...
              <a href="<?php echo e(route('lang' , 'ae' )); ?>" class="<?php echo e((App::getLocale()  == 'ae') ? 'active' : ''); ?>">
                <div class="lang <?php echo e((App::getLocale()  == 'ae') ? 'selected' : ''); ?>" data-value="en"><i class="flag-icon flag-icon-eg"></i> <span class="lang-txt">لعربية</span> <span> (ae)</span></div>
              </a>
            </div>
          </div>
        </li>
        ...
        <li class="profile-nav onhover-dropdown p-0 me-0">
          ...
          <ul class="profile-dropdown onhover-show-div">
            ...
            <li><a href="<?php echo e(route('admin.logout')); ?>"><i data-feather="log-out"> </i><span>تسجيل الخروج</span></a></li>
          </ul>
        </li>
      </ul>
    </div>
...
<?php /**PATH C:\Users\HP\OneDrive\Desktop\_\codeing\work\mazen\wikala\resources\views/layouts/simple/header.blade.php ENDPATH**/ ?>