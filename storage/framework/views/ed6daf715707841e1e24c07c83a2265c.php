			...
			<div id="sidebar-menu">
				<ul class="sidebar-links" id="simple-bar">
					...
					<li class="sidebar-list">
						<label class="badge badge-success"></label><a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/dashboard' ? 'active' : ''); ?>" href="#"><i data-feather="home"></i><span class="lan-3">لوحة التحكم</span>
						...
						<ul class="sidebar-submenu" style="display: <?php echo e(request()->route()->getPrefix() == '/dashboard' ? 'block;' : 'none;'); ?>">
							...
							<li><a class="lan-4 <?php echo e(Route::currentRouteName()=='category.index' ? 'active' : ''); ?>" href="<?php echo e(route('category.index')); ?>"><?php echo e("category"); ?></a></li>
							<li><a class="lan-4 <?php echo e(Route::currentRouteName()=='category.create' ? 'active' : ''); ?>" href="<?php echo e(route('category.create')); ?>"><?php echo e("add category"); ?></a></li>
					...
					<li class="sidebar-list">
	                    ...
	                    <ul class="sidebar-submenu" style="display: <?php echo e(request()->route()->getPrefix() == '/users' ? 'block;' : 'none;'); ?>">
                          ...
                          <li><a href="<?php echo e(route('seller.index')); ?>" class="<?php echo e(Route::currentRouteName() == 'seller.index' ? 'active' : ''); ?>">Sellers</a></li>
                          <li><a href="<?php echo e(route('seller.create')); ?>" class="<?php echo e(Route::currentRouteName() == 'seller.create' ? 'active' : ''); ?>"> add Seller</a></li>
					...
					<li class="sidebar-list">
						<a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/evaluations' ? 'active' : ''); ?>" href="#">
							<i data-feather="star"></i><span>التقييمات</span>
							<div class="according-menu"><i class="fa fa-angle-<?php echo e(request()->route()->getPrefix() == '/evaluations' ? 'down' : 'right'); ?>"></i></div>
						</a>
					...
					<li class="sidebar-list">
						<a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/notifications' ? 'active' : ''); ?>" href="#">
							<i data-feather="bell"></i><span>الاشعارات</span>
						...
						<ul class="sidebar-submenu" style="display: <?php echo e(request()->route()->getPrefix() == '/notifications' ? 'block' : 'none;'); ?>;">
							<li><a href="<?php echo e(route('admin.notifications.index')); ?>" class="<?php echo e(Route::currentRouteName()=='admin.notifications.index' ? 'active' : ''); ?>"> عرض الاشعارات</a></li>
						</ul>
					</li>

					<li class="sidebar-list">
						<a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/financial' ? 'active' : ''); ?>" href="#">
							<i data-feather="dollar-sign"></i><span>الباقات والخصومات</span>
							<div class="according-menu"><i class="fa fa-angle-<?php echo e(request()->route()->getPrefix() == '/financial' ? 'down' : 'right'); ?>"></i></div>
						</a>
						<ul class="sidebar-submenu" style="display: <?php echo e(request()->route()->getPrefix() == '/financial' ? 'block' : 'none;'); ?>;">
							<li><a href="<?php echo e(route('discounts.index')); ?>" class="<?php echo e(Route::currentRouteName()=='discounts.index' ? 'active' : ''); ?>">عرض الخصومات</a></li>
						</ul>
						<ul class="sidebar-submenu" style="display: <?php echo e(request()->route()->getPrefix() == '/financial' ? 'block' : 'none;'); ?>;">
							<li><a href="<?php echo e(route('discounts.create')); ?>" class="<?php echo e(Route::currentRouteName()=='discounts.create' ? 'active' : ''); ?>">اضافة خصومات</a></li>
						</ul>
					...
					<li class="sidebar-list">
						<a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/settings' ? 'active' : ''); ?>" href="#">
							...
							<div class="according-menu"><i class="fa fa-angle-<?php echo e(request()->route()->getPrefix() == '/settings' ? 'down' : 'right'); ?>"></i></div>
						</a>
						<ul class="sidebar-submenu" style="display: <?php echo e(request()->route()->getPrefix() == '/settings' ? 'block' : 'none;'); ?>;">
							<li><a href="<?php echo e(route('settings.edit')); ?>" class="<?php echo e(Route::currentRouteName()=='settings.edit' ? 'active' : ''); ?>">عرض الاعدادت</a></li>
						</ul>
...
</div><?php /**PATH C:\Users\HP\OneDrive\Desktop\_\codeing\work\mazen\wikala\resources\views/layouts/simple/sidebar.blade.php ENDPATH**/ ?>