					...
					<form class="needs-validation" novalidate="" method="POST" enctype="multipart/form-data" action="<?php echo e(route('settings.update')); ?>">
						...
						<div class="row">
							...
							<div class="col-md-6 mb-3">
								...
								<input class="form-control" id="validationCustom01" type="number" name="ads_time_user" value="<?php echo e($settings->ads_time_user); ?>" placeholder="ads_time_user" required="">
								<div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">Please choose a ads time user.</div>
							</div>

							<div class="col-md-6 mb-3">
								<label for="validationCustom01"><?php echo app('translator')->get('lang.ads_time_business'); ?></label>
								<input class="form-control" id="validationCustom01" type="number" name="ads_time_business" value="<?php echo e($settings->ads_time_business); ?>" placeholder="ads_time_business" required="">
								<div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">Please choose a ads time business.</div>
							</div>
							<div class="col-md-6 mb-3">
								<label for="validationCustom01"><?php echo app('translator')->get('lang.free_ads_user'); ?></label>
								<input class="form-control" id="validationCustom01" type="number" name="free_ads_user" value="<?php echo e($settings->free_ads_user); ?>" placeholder="free_ads_user" required="">
								<div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">Please choose a free ads user.</div>
							</div>
							<div class="col-md-6 mb-3">
								<label for="validationCustom01"><?php echo app('translator')->get('lang.free_ads_business'); ?></label>
								<input class="form-control" id="validationCustom01" type="number" name="free_ads_business" value="<?php echo e($settings->free_ads_business); ?>" placeholder="free_ads_business" required="">
								<div class="valid-feedback">Looks good!</div>
